...
export class UserService {
  ...
  public GetAllReviewsForUser(_userId: string): Observable<ApiResponse> {
    return this.httpClient.get<ApiResponse>(`${CommonUtilsService.getAbsoluteUrl()}/reviewsForUser/${_userId}`);
  }
