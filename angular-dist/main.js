...
var ScheduleCaregiverComponent = /** @class */ (function () {
    ...
    ScheduleCaregiverComponent.prototype.getStarRatings = function () {
        var _arr = this.getReviewsForId().map(function (rev) {
    ...
    ScheduleCaregiverComponent.prototype.getReviewsForId = function () {
        return this.reviews$;
    };
